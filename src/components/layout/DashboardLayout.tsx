  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(180deg, #f0fdf4 0%, #dcfce7 40%, #bbf7d0 70%, #f0fdf4 100%)', color: '#1a1a2e' }}>
      ...
      <main className="lg:pl-[260px] w-full">
       <div className={`min-h-screen pt-16 lg:pt-0 px-3 sm:px-4 py-4 sm:py-5 lg:p-8 ${isAdmin ? 'text-sm [&_th]:h-10 [&_th]:text-xs [&_td]:py-3 [&_label]:text-[13px] [&_input]:text-sm' : ''}`}>
